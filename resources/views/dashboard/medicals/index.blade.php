...
@section('section')
    ...
    {{-- رفع ملف Excel --}}
    <form action="{{ route('medicals.upload') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
    ...
    <form method="GET" action="{{ route('medicals.index') }}" class="mb-3">
        <div class="input-group">
            <input type="text" name="q" value="{{ request('q') }}" class="form-control" placeholder="ابحث بالاسم أو الشركة أو التركيب">
