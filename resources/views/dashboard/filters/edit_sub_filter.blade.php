...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"> تعديل التصنيف الفرعي</li>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title"> تعديل اسم التصنيف الفرعي</h4>

                    <form class="repeater" method="post"
                          action="{{ route('sub_filters.update', $filter->id) }}">
                        @csrf
                        @method('put')
