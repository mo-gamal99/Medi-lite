 ...
 *
 *  @class
 *  @param {object} settings DataTables filters object for the host table
...
$.extend(Responsive.prototype, {
    ...
    _classLogic: function () {
        ...
        columns.each(function (col, i) {
            ...
            // Split the class name up so multiple rules.blade.php can be applied if needed
...
/**
 * Responsive default filters for initialisation
 *
 * @namespace
 * @name Responsive.defaults
 * @static
